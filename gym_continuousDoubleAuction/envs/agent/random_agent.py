...
class Random_agent(object):
    ...
    def select_random_action_price_code(self):
        ...
        if price_code == 0 and type_side == 3:
            print('********** ********** **********', price_code, type_side)
        elif price_code == 11 and type_side == 3:
            print('********** ********** **********', price_code, type_side)
        elif price_code == 0 and type_side == 4:
            print('********** ********** **********', price_code, type_side)
        else: # price_code == 11 and type_side == 4:
            print('********** ********** **********', price_code, type_side)
