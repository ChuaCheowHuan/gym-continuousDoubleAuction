...
**Setting up training?**
[self_play_league.md](self_play_league.md) → [logging.md](logging.md) →
[known_issues.md](known_issues.md) §3.1–3.2 (the training stack does not currently build cleanly)
