...
class test_OrderBook(object):
    """docstring for test_OrderBook.
    Testing of operations for OrderBook with expected results (string output).
    """

    def __init__(self):
        super(test_OrderBook, self).__init__()

        # Create an order book
        self.order_book = OrderBook()

        # Create some limit orders
        self.limit_orders = [{'type' : 'limit', 'side' : 'ask', 'quantity' : 5, 'price' : 101, 'trade_id' : 100},
    ...
    def test_1(self):
        ...
        for order in self.limit_orders:
            trades, order_id = self.order_book.process_order(order, False, False)
        ...
        ans = "***Bids***" + "\n" + \
              ...
              "3    5   103       101          2         2" + "\n" + \
              "***tape***" + "\n\n"
        assert str(self.order_book) == ans, "self.order_book.process_order ERROR."
    ...
    def test_2(self):
        ...
        trades, order_in_book = self.order_book.process_order(crossing_limit_order, False, False)
        ...
        assert str(trades) == ans, "self.order_book.process_order ERROR."
    ...
    def test_3(self):
        ...
        big_crossing_limit_order = {'type': 'limit', 'side': 'bid', 'quantity': 50, 'price': 102, 'trade_id': 110}
        print(big_crossing_limit_order)

        trades, order_in_book = self.order_book.process_order(big_crossing_limit_order, False, False)
    ...
    def test_4(self):
        ...
        trades, order_id = self.order_book.process_order(market_order, False, False)
...
# test
a_test_OrderBook = test_OrderBook()
a_test_OrderBook.test_1()
a_test_OrderBook.test_2()
a_test_OrderBook.test_3()
a_test_OrderBook.test_4()
