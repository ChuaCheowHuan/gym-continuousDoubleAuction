...
class TestOrderBookVolumeSync:
    ...
    def test_partial_fill_volume_sync(self):
        ...
        assert initial_tree_vol == Decimal('10')
        assert initial_calc_vol == Decimal('10')
        ...
        assert final_calc_vol == Decimal('6'), "Manual calculation shows volume should be 6"
        assert final_tree_vol == Decimal('6'), "OrderTree.volume should be 6 after partial fill"
