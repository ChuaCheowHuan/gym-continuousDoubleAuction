...
class ParametricActionCartpole(ray.rllib.env.MultiAgentEnv):
    ...
    def step(self, action_dict):
        ...
        return {0: obs}, {0: rew}, {"__all__": done}, {0: info}
...
if __name__ == "__main__":
    ...
    dummy = ParametricActionCartpole(10)
    ...
    run_experiments({
        "parametric_cartpole": {
            ...
            "config": dict({
                "multiagent": {
                    "policy_graphs": {
                        "cart": (PPOPolicyGraph, obs_space, act_space, {"model": {
                            "custom_model": "pa_model",
                        }}),
                    },
                    "policy_mapping_fn": tune.function(lambda _: "cart"),
                },
                "num_workers": 0,
            }, **cfg),
        },
