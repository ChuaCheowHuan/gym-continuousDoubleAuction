...
|---|---|---|
| `raw` | The observation itself, all 193 floats | The floor. Every latent is a *function* of this vector |
...
The grid reaches `1e7` deliberately. `raw` is 193 standardised features, and a short corpus gives a
