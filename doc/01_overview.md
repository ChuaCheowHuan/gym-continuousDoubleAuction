...
| Observation | 193 floats — 4 stacked snapshots × 46 shared book, plus a 9-float per-agent private block | `observation_layout`, [`tunable_constants.json`](../config/tunable_constants.json) |
...
| `python -m pytest gym_continuousDoubleAuction/test -q` | 1,067 tests (914 unit + 153 integration) |
